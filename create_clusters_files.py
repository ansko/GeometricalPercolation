...
def create_clusters_files(fname_intersections, fname_clusters, fname_minmaxes):
    """
    Creates from files with intersection files with clusters
    """
    fin = open(fname_intersections, 'r')
    # read intersections
    intersections = []
    clusters = []
    for line in fin:
